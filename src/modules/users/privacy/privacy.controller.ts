...
export class PrivacyController {
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Privacy settings retrieved successfully', type: PrivacySettings })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Privacy settings not found' })
  ...
  @ApiParam({ name: 'userId', type: 'string', format: 'uuid', description: 'User ID' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Privacy settings updated successfully', type: PrivacySettings })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Privacy settings not found' })
  ...
  @ApiParam({ name: 'viewerId', type: 'string', format: 'uuid', description: 'Viewer user ID' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Permission check result', schema: { type: 'boolean' } })
