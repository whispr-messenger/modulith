...
export class UserRepository {
     ...
     */
    async findByPhoneNumberWithFilter(phoneNumber: string, includeInactive: boolean = false, relations?: string[],): Promise<User | null> {
        return this.repository.findOne({
            where: {
                phoneNumber,
     ...
     */
    async findByUsernameInsensitive(username: string, includeInactive: boolean = false, relations?: string[]): Promise<User | null> {
        return this.repository.findOne({
            where: {
